package com.mercury.shop.security;
...
import com.mercury.shop.security.handler.AccessDeniedHandlerImpl;
import com.mercury.shop.security.handler.AuthenticationEntryPointImpl;
import com.mercury.shop.security.handler.AuthenticationFailureHandlerImpl;
import com.mercury.shop.security.handler.AuthenticationSuccessHandlerImpl;
import com.mercury.shop.security.handler.LogoutSuccessHandlerImpl;
...
//    	.and()
        http.csrf().disable()
        		.cors() // cors config.
        			.and()
            .authorizeRequests()
            	.antMatchers("/mail","/index.html", "/products", "/products/*", "/products/*/*","/product/*","/users*","/users/*").permitAll()
